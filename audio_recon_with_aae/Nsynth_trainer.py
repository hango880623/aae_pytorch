...
tensorboard_path = RESULT + '/analysis/'
saved_model_path = RESULT + '/models/'
log_path = RESULT + '/analysis/'
...
def train(Q, P, D_gauss, Q_encoder, P_decoder, Q_generator, D_gauss_solver, data_loader, epoch, log_path, writer, device):
    '''
...
def valid(Q, P, D_gauss, Q_encoder_reduce, P_decoder_reduce, Q_generator_reduce, D_gauss_solver_reduce, data_loader,epoch,log_path,writer, device):
    Q.eval()
    P.eval()
    D_gauss.eval()
    with torch.no_grad():
